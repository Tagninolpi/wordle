...
class Config:
    ...
    ALLOWED_CATEGORY_ID: list[int] | None = [1512172461448495327,1407088161364115682]   # <-- replace with your category ID

    # Channels must start with this prefix (case-insensitive) to be allowed
    ALLOWED_CHANNEL_PREFIX: str = "⚔️-maggod-lobby"
    ...
    DEV_GUILD_IDS: list[int] = [1510658770483544164,1096028646323527740]      # e.g. [123456789012345678]

    # ── Wordle game settings ─────────────────────────────────────────────────
    WORDLE_MENU_TIMEOUT:    int = 300   # seconds before menu times out
    WORDLE_GAME_TIMEOUT:    int = 900   # seconds before a live game times out
